...
def global_macro():
    client_sdm_setup.add_macros_for_many_accounts(
        accounts=AccountGroup.ag_rab_01_to_05,
        files=[
            # GM command
...
def s_09_holy_protect_paladin():
    client_sdm_setup.add_macros_for_many_chars(
        ...
        files=[
            ...
            # Act
            Macros.sdm_02_paladin____0_common____27171_high_int_heal_rotation_zhTW,
            Macros.sdm_02_paladin____0_common____27172_high_crt_heal_rotation_zhTW,
