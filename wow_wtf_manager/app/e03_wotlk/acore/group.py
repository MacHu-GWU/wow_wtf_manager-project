...
class CharacterEnum:
    ...
    fat11_acore_rk = Character.from_string("Fat11.AzerothCore.Rj")
    fat12_acore_rl = Character.from_string("Fat12.AzerothCore.Rj")
    fat13_acore_rm = Character.from_string("Fat13.AzerothCore.Rj")
    fat14_acore_rn = Character.from_string("Fat14.AzerothCore.Rj")
    fat15_acore_ro = Character.from_string("Fat15.AzerothCore.Rj")
    fat16_acore_rp = Character.from_string("Fat16.AzerothCore.Rj")
    fat17_acore_rq = Character.from_string("Fat17.AzerothCore.Rj")
    fat18_acore_rr = Character.from_string("Fat18.AzerothCore.Rj")
    fat19_acore_rs = Character.from_string("Fat19.AzerothCore.Rj")
    fat20_acore_rt = Character.from_string("Fat20.AzerothCore.Rj")
    fat21_acore_ru = Character.from_string("Fat21.AzerothCore.Rj")
    fat22_acore_rv = Character.from_string("Fat22.AzerothCore.Rj")
    fat23_acore_rw = Character.from_string("Fat23.AzerothCore.Rj")
    fat24_acore_rx = Character.from_string("Fat24.AzerothCore.Rj")
    fat25_acore_ry = Character.from_string("Fat25.AzerothCore.Rj")
