...
Fatmulti1_Icecrown_Litgoatdka = Character.from_string("Fatmulti1.Icecrown.Litgoatdka")
Fatmulti1_Icecrown_Litgoatdza = Character.from_string("Fatmulti1.Icecrown.Litgoatdza")
Fatmulti2_Icecrown_Quentinquinn = Character.from_string("Fatmulti2.Icecrown.Quentinquinn")
Fatmulti2_Icecrown_Litgoatssb = Character.from_string("Fatmulti2.Icecrown.Litgoatssb")
Fatmulti2_Icecrown_Litgoatzsb = Character.from_string("Fatmulti2.Icecrown.Litgoatzsb")
Fatmulti2_Icecrown_Litgoatdkb = Character.from_string("Fatmulti2.Icecrown.Litgoatdkb")
Fatmulti2_Icecrown_Litgoatdzb = Character.from_string("Fatmulti2.Icecrown.Litgoatdzb")
Fatmulti3_Icecrown_Opiitou = Character.from_string("Fatmulti3.Icecrown.Opiitou")
Fatmulti3_Icecrown_Litgoatssc = Character.from_string("Fatmulti3.Icecrown.Litgoatssc")
Fatmulti3_Icecrown_Litgoatzsc = Character.from_string("Fatmulti3.Icecrown.Litgoatzsc")
Fatmulti3_Icecrown_Litgoatdkc = Character.from_string("Fatmulti3.Icecrown.Litgoatdkc")
Fatmulti3_Icecrown_Litgoatdzc = Character.from_string("Fatmulti3.Icecrown.Litgoatdzc")
Fatmulti4_Icecrown_Swagsonic = Character.from_string("Fatmulti4.Icecrown.Swagsonic")
Fatmulti4_Icecrown_Litgoatssd = Character.from_string("Fatmulti4.Icecrown.Litgoatssd")
Fatmulti4_Icecrown_Litgoatzsd = Character.from_string("Fatmulti4.Icecrown.Litgoatzsd")
Fatmulti4_Icecrown_Litgoatdkd = Character.from_string("Fatmulti4.Icecrown.Litgoatdkd")
Fatmulti4_Icecrown_Litgoatdzd = Character.from_string("Fatmulti4.Icecrown.Litgoatdzd")
Fatmulti5_Icecrown_Kangliu = Character.from_string("Fatmulti5.Icecrown.Kangliu")
Fatmulti5_Icecrown_Litgoatsse = Character.from_string("Fatmulti5.Icecrown.Litgoatsse")
Fatmulti5_Icecrown_Litgoatzse = Character.from_string("Fatmulti5.Icecrown.Litgoatzse")
Fatmulti5_Icecrown_Litgoatdke = Character.from_string("Fatmulti5.Icecrown.Litgoatdke")
Fatmulti5_Icecrown_Litgoatdze = Character.from_string("Fatmulti5.Icecrown.Litgoatdze")
Fitsheep_Icecrown_Kindhearted = Character.from_string("Fitsheep.Icecrown.Kindhearted")
Fitsheep_Icecrown_Bordercollie = Character.from_string("Fitsheep.Icecrown.Bordercollie")
Fitsheep_Icecrown_Sweetmonk = Character.from_string("Fitsheep.Icecrown.Sweetmonk")
Fitsheep_Icecrown_Angorarabbit = Character.from_string("Fitsheep.Icecrown.Angorarabbit")
Fitsheep_Icecrown_Sheepbunny = Character.from_string("Fitsheep.Icecrown.Sheepbunny")
Fitsheep_Icecrown_Angrybunny = Character.from_string("Fitsheep.Icecrown.Angrybunny")
Fitsheep_Icecrown_Juicysheep = Character.from_string("Fitsheep.Icecrown.Juicysheep")
Fitsheep_Icecrown_Chunlily = Character.from_string("Fitsheep.Icecrown.Chunlily")
Fatmulti6_Icecrown_Kapacuk = Character.from_string("Fatmulti6.Icecrown.Kapacuk")
Fatmulti6_Icecrown_Litgoatssh = Character.from_string("Fatmulti6.Icecrown.Litgoatssh")
Fatmulti6_Icecrown_HealthyMonk = Character.from_string("Fatmulti6.Icecrown.HealthyMonk")
Fatmulti6_Icecrown_Litgoatxdh = Character.from_string("Fatmulti6.Icecrown.Litgoatxdh")
Fatmulti8_Icecrown_Bunnysisters = Character.from_string("Fatmulti8.Icecrown.Bunnysisters")
Fatmulti8_Icecrown_Litgoatssi = Character.from_string("Fatmulti8.Icecrown.Litgoatssi")
Fatmulti8_Icecrown_Honeymonk = Character.from_string("Fatmulti8.Icecrown.Honeymonk")
Fatmulti8_Icecrown_Litgoatxdi = Character.from_string("Fatmulti8.Icecrown.Litgoatxdi")
Fatmulti9_Icecrown_Glowyy = Character.from_string("Fatmulti9.Icecrown.Glowyy")
Fatmulti9_Icecrown_Litgoatssj = Character.from_string("Fatmulti9.Icecrown.Litgoatssj")
Fatmulti9_Icecrown_ChubbyMonk = Character.from_string("Fatmulti9.Icecrown.ChubbyMonk")
Fatmulti9_Icecrown_Litgoatxdj = Character.from_string("Fatmulti9.Icecrown.Litgoatxdj")
Fatmulti10_Icecrown_Luxiaofeng = Character.from_string("Fatmulti10.Icecrown.Luxiaofeng")
Fatmulti10_Icecrown_Litgoatssk = Character.from_string("Fatmulti10.Icecrown.Litgoatssk")
Fatmulti10_Icecrown_ShinyMonk = Character.from_string("Fatmulti10.Icecrown.ShinyMonk")
Fatmulti10_Icecrown_Litgoatxdk = Character.from_string("Fatmulti10.Icecrown.Litgoatxdk")
Makun7551_Icecrown_Laoshou = Character.from_string("Makun7551.Icecrown.Laoshou")
Makun7551_Icecrown_Ganjj = Character.from_string("Makun7551.Icecrown.Ganjj")
Monkey130_Icecrown_Flydps = Character.from_string("Monkey130.Icecrown.Flydps")
Fatmulti11_Icecrown_Litgugua = Character.from_string("Fatmulti11.Icecrown.Litgugua")
Fatmulti12_Icecrown_Litgugub = Character.from_string("Fatmulti12.Icecrown.Litgugub")
Fatmulti13_Icecrown_Litguguc = Character.from_string("Fatmulti13.Icecrown.Litguguc")
Fatmulti14_Icecrown_Litgugud = Character.from_string("Fatmulti14.Icecrown.Litgugud")
Fatmulti15_Icecrown_Litgugue = Character.from_string("Fatmulti15.Icecrown.Litgugue")
Fatmulti16_Icecrown_Litguguf = Character.from_string("Fatmulti16.Icecrown.Litguguf")
Fatmulti17_Icecrown_Litgugug = Character.from_string("Fatmulti17.Icecrown.Litgugug")
Fatmulti18_Icecrown_Litguguh = Character.from_string("Fatmulti18.Icecrown.Litguguh")
Fatmulti19_Icecrown_lgmsi = Character.from_string("Fatmulti19.Icecrown.lgmsi")
Fatmulti20_Icecrown_lgmsj = Character.from_string("Fatmulti20.Icecrown.lgmsj")
Fatmulti21_Icecrown_lgmsk = Character.from_string("Fatmulti21.Icecrown.lgmsk")
Fatmulti22_Icecrown_lgmsl = Character.from_string("Fatmulti22.Icecrown.lgmsl")
Fatmulti23_Icecrown_lgsmm = Character.from_string("Fatmulti23.Icecrown.lgsmm")
Fatmulti24_Icecrown_lgsmn = Character.from_string("Fatmulti24.Icecrown.lgsmn")
