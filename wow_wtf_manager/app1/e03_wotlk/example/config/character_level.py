...
class CharacterAddonsConfigEnum:
    ...
    mb_master_non_pala = wotlk.CharacterAddonsConfig.new(
        app_data.dir_25_character_addons.joinpath("02-multiboxer-master-non-paladin.txt"),
    )
    ...
    mb_slave_non_pala = wotlk.CharacterAddonsConfig.new(
        app_data.dir_25_character_addons.joinpath("04-multiboxer-slave-non-paladin.txt"),
    )
